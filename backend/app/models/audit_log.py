...
class AuditEventType(str, Enum):
    ...
    SCRIPT_RESUBMITTED = "SCRIPT_RESUBMITTED"
    BUNDLE_SUBMITTED = "BUNDLE_SUBMITTED"
    BUNDLE_AUTO_VALIDATED = "BUNDLE_AUTO_VALIDATED"
    BUNDLE_APPROVED = "BUNDLE_APPROVED"
    BUNDLE_REJECTED = "BUNDLE_REJECTED"
    BUNDLE_EXECUTION_STARTED = "BUNDLE_EXECUTION_STARTED"
    BUNDLE_EXECUTED = "BUNDLE_EXECUTED"
    BUNDLE_EXECUTION_FAILED = "BUNDLE_EXECUTION_FAILED"
    BUNDLE_RESUBMITTED = "BUNDLE_RESUBMITTED"
